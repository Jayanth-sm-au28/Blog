        ...
        <div className="w-full flex items-center justify-between my-auto md:gap-4 lg:gap-6 2xl:px-[7.5rem] xl:px-[6rem] lg:px-[4.5rem] md:px-[3rem] px-[1.5rem] max-w-screen-2xl mx-auto">
          ...
          <div className="flex">
            <div className="nav-buttons gap-4 self-center flex">
              <Link type="button" className=" rounded-md text-white border border-[#6938EF] bg-[#6938EF] hover:bg-[#8555FF] hover:border hover:border-[#6938EF] px-4 py-1.5 font-semibold request-demo xs:hidden" href="/demo">
                Request Demo
              </Link>
